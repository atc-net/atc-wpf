...
public sealed class CSharp : CLike
{
    ...
    /// </summary>
    protected override string Keywords => "abstract as "
                                          ...
                                          + "partial params private protected public "
                                          + "record readonly ref return "
                                          + "set sbyte sealed short sizeof stackalloc static string struct switch "
