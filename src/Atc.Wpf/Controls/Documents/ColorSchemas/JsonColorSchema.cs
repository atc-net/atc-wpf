namespace Atc.Wpf.Controls.Documents.ColorSchemas;
...
public static class JsonColorSchema
{
    ...
    private static readonly SolidColorBrush DarkGuidBrush = new(Color.FromRgb(171, 71, 188));
    ...
    private static readonly SolidColorBrush DarkNullBrush = new(Colors.Gray);
