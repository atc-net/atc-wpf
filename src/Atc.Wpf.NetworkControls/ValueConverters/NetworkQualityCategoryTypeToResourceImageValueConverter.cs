namespace Atc.Wpf.NetworkControls.ValueConverters;
...
public class NetworkQualityCategoryTypeToResourceImageValueConverter : IValueConverter
{
    ...
    private const string ResourceBasePath = "pack://application:,,,/Atc.Wpf.NetworkControls;component/Resources/Images/";
