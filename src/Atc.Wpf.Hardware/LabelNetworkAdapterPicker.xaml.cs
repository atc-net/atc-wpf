...
public partial class LabelNetworkAdapterPicker : ILabelNetworkAdapterPicker
{
    [DependencyProperty]
    private NetworkAdapterInfo? value;
    ...
    public override bool IsValid()
    {
        Validate(
            this,
            new RoutedPropertyChangedEventArgs<NetworkAdapterInfo?>(oldValue: null, newValue: Value),
            raiseEvents: false);
    ...
    private void OnValueChanged(
        object sender,
        RoutedPropertyChangedEventArgs<NetworkAdapterInfo?> e)
    {
        ...
        PropertyChangedEventArgs e)
    {
        ...
        Validate(
            this,
            new RoutedPropertyChangedEventArgs<NetworkAdapterInfo?>(Value, Value),
            raiseEvents: false);
    }

    private static void Validate(
        LabelNetworkAdapterPicker control,
        RoutedPropertyChangedEventArgs<NetworkAdapterInfo?> e,
        bool raiseEvents)
    {
        ...
        RoutedPropertyChangedEventArgs<NetworkAdapterInfo?> e)
    {
        control.LostFocusValid?.Invoke(
            control,
            new ValueChangedEventArgs<NetworkAdapterInfo?>(
