...
public partial class LabelSerialPortPicker : ILabelSerialPortPicker
{
    [DependencyProperty]
    private SerialPortInfo? value;
    ...
    public event EventHandler<ValueChangedEventArgs<SerialPortInfo?>>? LostFocusValid;

    public event EventHandler<ValueChangedEventArgs<SerialPortInfo?>>? LostFocusInvalid;

    public LabelSerialPortPicker()
    {
        InitializeComponent();
    }
    ...
    public override bool IsValid()
    {
        Validate(
            this,
            new RoutedPropertyChangedEventArgs<SerialPortInfo?>(oldValue: null, newValue: Value),
            raiseEvents: false);
        ...
        PropertyChangedEventArgs e)
    {
        ...
        Validate(
            this,
            new RoutedPropertyChangedEventArgs<SerialPortInfo?>(Value, Value),
            raiseEvents: false);
    }

    private static void Validate(
        LabelSerialPortPicker control,
        RoutedPropertyChangedEventArgs<SerialPortInfo?> e,
        bool raiseEvents)
    {
        ...
        {
            // Informational, not a hard validation failure — surface via the
            // validation slot so it stays inline (no layout shift) but don't
            // fire LostFocusInvalid.
        ...
        RoutedPropertyChangedEventArgs<SerialPortInfo?> e)
    {
        control.LostFocusValid?.Invoke(
            control,
            new ValueChangedEventArgs<SerialPortInfo?>(
