...
public partial class AudioInputPicker
{
    [RoutedEvent(
    ...
    internal AudioInputPicker(IAudioDeviceService service)
    {
        ...
        RoutedEventArgs e)
    {
        ...
        {
            Debug.WriteLine($"AudioInputPicker initial refresh failed: {ex.Message}");
        }
        ...
        RoutedEventArgs e)
    {
        ...
        {
            Debug.WriteLine($"AudioInputPicker refresh failed: {ex.Message}");
        }
    }
