...
public partial class BluetoothDevicePicker
{
    [RoutedEvent(
    ...
    internal BluetoothDevicePicker(IBluetoothDeviceService service)
    {
    ...
    private void HookItem(BluetoothDeviceInfo device)
    {
        lastKnownStates[device.DeviceId] = device.State;
        device.PropertyChanged += OnDeviceStatePropertyChanged;
    }

    private void UnhookItem(BluetoothDeviceInfo device)
    {
        device.PropertyChanged -= OnDeviceStatePropertyChanged;
        ...
        PropertyChangedEventArgs e)
    {
        if (e.PropertyName != nameof(BluetoothDeviceInfo.State) ||
            sender is not BluetoothDeviceInfo device)
        {
            return;
        }
        ...
        RoutedEventArgs e)
    {
        ...
        {
            Debug.WriteLine($"BluetoothDevicePicker initial refresh failed: {ex.Message}");
        }
        ...
        RoutedEventArgs e)
    {
        ...
        {
            Debug.WriteLine($"BluetoothDevicePicker refresh failed: {ex.Message}");
        }
    }
        ...
        System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
    {
        if (e.OldItems is not null)
        {
            ...
            {
                if (item is BluetoothDeviceInfo removed)
                {
                    UnhookItem(removed);
                }
            }
            ...
            e.NewItems is not null)
        {
            ...
            {
                if (item is not BluetoothDeviceInfo info)
                {
                    continue;
                }
                ...
                {
                    Value = info;
                    RaiseEvent(new RoutedPropertyChangedEventArgs<BluetoothDeviceInfo?>(null, info, DeviceReconnectedEvent));
                    lostDeviceId = null;
                }
    ...
    private void HandleSelectedDeviceLost()
    {
        ...
        RaiseEvent(new RoutedPropertyChangedEventArgs<BluetoothDeviceInfo?>(lost, lost, DeviceLostEvent));
