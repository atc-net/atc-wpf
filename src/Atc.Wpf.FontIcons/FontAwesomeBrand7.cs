...
public sealed class FontAwesomeBrand7 : TextBlock, ISpinable, IRotatable, IFlippable
{
    /// <summary>
    ...
    public static readonly DependencyProperty IconProperty = DependencyProperty.Register(
        ...
        typeof(FontAwesomeBrand7),
        new PropertyMetadata(FontAwesomeBrand7Type.None, OnIconChanged));
    ...
    {
        d.SetCurrentValue(FontFamilyProperty, ResourceFontHelper.GetAwesome7Brand());
    ...
    private static void OnSpinDurationChanged(
        ...
        DependencyPropertyChangedEventArgs e)
    {
        if (d is not FontAwesomeBrand7 { Spin: true } fontAwesome ||
    ...
    private static void OnSpinChanged(
        ...
        DependencyPropertyChangedEventArgs e)
    {
        if (d is not FontAwesomeBrand7 fontAwesome)
        {
            return;
        }
