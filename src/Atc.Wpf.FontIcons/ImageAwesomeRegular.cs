...
public class ImageAwesomeRegular : Image, ISpinable, IRotatable, IFlippable
{
    /// <summary>
    ...
    public static readonly DependencyProperty IconProperty = DependencyProperty.Register(
        ...
        typeof(ImageAwesomeRegular),
        new PropertyMetadata(FontAwesomeRegularType.None, OnIconPropertyChanged));
    ...
    /// </summary>
    private static readonly Typeface FontAwesomeRegularTypeface = new(
        ResourceFontHelper.GetAwesomeRegular(),
        FontStyles.Normal,
        FontWeights.Normal,
    ...
    private static void OnSpinDurationChanged(
        ...
        DependencyPropertyChangedEventArgs e)
    {
        if (d is not ImageAwesomeRegular { Spin: true } imageAwesome ||
