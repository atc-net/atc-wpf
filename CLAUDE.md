...
|--------------|------------|-----------:|
| `Atc.Wpf.Tests` | Core library (Helpers, ValueConverters, Serialization) | 85 |
...
> Counts are test-file counts; total executed tests are higher (e.g. `Atc.Wpf.Tests` runs 869 tests across 85 files).
