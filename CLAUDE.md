...
| Wpf.Hardware | `SamplesWpfHardwareTreeView.xaml` | SerialPortPicker, UsbPortPicker, UsbCameraPicker, AudioInputPicker, AudioOutputPicker, DrivePicker, TimeZonePicker, BluetoothDevicePicker, ProcessPicker, WindowPicker |
