...
- **Atc.Wpf.Hardware** - Hardware / system pickers (SerialPortPicker, UsbPortPicker, UsbCameraPicker, AudioInputPicker, AudioOutputPicker, DrivePicker, TimeZonePicker) with live device-state detection. TFM `net10.0-windows10.0.19041.0` (uses `Windows.Devices.Enumeration.DeviceWatcher` for the hardware-backed pickers)
...
| Wpf.Hardware | `SamplesWpfHardwareTreeView.xaml` | SerialPortPicker, UsbPortPicker, UsbCameraPicker, AudioInputPicker, AudioOutputPicker, DrivePicker, TimeZonePicker |
