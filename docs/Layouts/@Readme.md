...
| 🎨 Containers | 3 | DockPanelPro, GridLines, GroupBoxExpander |

> **See also:** [Data Display Controls](../DataDisplay/@Readme.md) for Avatar, Badge, Card, Chip, and Divider controls.
